...
class Home extends CI_Controller {
    ...
    public function register(){
        ...
        $this->form_validation
            ...
            ->set_rules('password', 'Password', 'required|trim|min_length[4]|max_length[20]')
    ...
    public function login(){
        ...
        if($this->form_validation->run()){
            ...
            if(is_object($userData)){
                ...
                $viewData['error'] = 'Почта или пароль были введены неверно.';
            }
        }
    ...
    public function add_cart($item_id){
        if(!isset($this->userData['logged'])){
            $this->add_alert('warning', 'Необходимо зарегистрироваться.');
            ...
            $this->add_alert('success', 'Товар добавлен в корзину.');
